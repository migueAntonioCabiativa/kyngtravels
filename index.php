...
<body>
    <main class="d-flex align-items-center d-flex flex-column align-items-center">
      ...
      <div class="subscribe m-4">
        <h4>¡Suscribete ahora, para que conozcas todos los beneficios!</h4>
        <form action="forms/notify.php" method="post" role="form" class="php-email-form">
          <div class="subscribe-form">
            <input type="email" name="email" placeholder="¡Ingresa tu correo aqui!"><input type="submit" value="Subscribe">
          </div>
          <div class="mt-2">
            <div class="loading">Loading</div>
            <div class="error-message"></div>
            <div class="sent-message">Ya estas subscrito, revisa la <b>andeja de entrada</b> de tu Correo para confirmar.</div>
            <div class="warning-message">El correo que ingresaste ya esta inscrito.</div>
          </div>
        </form>
...
<script src="assets/js/validate.js?version=1"></script>
</html>
